window.PAGE_DATA = {
  ...
  "preview": {
    ...
    "thingsToNote": {
      ...
      "items": [
        {
          "icon": "assets/icon-fork-knife-note.svg",
          "title": "Dine-in only",
        ...
        {
          "icon": "assets/icon-x-mark-doc.svg",
          "title": "Purchase restrictions",
          "description": "Limit purchase 2"
        },
        {
          "icon": "assets/icon-balance-refund-2.svg",
          "title": "Refund policy",
          "description": "100% refundable before redemption; voucher will be auto-refunded if unused by expiry date"
        },
        {
          "icon": "assets/icon-clipboard.svg",
          "title": "Other information",
          "description": "Optional field, only displayed when filled in by the merchant"
        }
      ]
    },
    "ctaLabel": "Buy for Rp0",
